	  ...
	  <div className="container">
		  ...
		  <div className="content">
			 {progress ==='pending' && (
			  ...
			  {progress !== 'pending' && (<div className="box-chat">
			  {chat [0] &&(
				  <h1>Você está estudando sobre <span>{chat[0]}</span></h1>
				)}
				{chat [1] && (
				  <div className="question">
					  <h2><img src="/asses/question.svg" /> Pergunta</h2>
					  <p>{chat[1]}</p>
				  </div>)}
			...
			{progress !== 'done' && (
				  ...
				  />
				  <button onClick={handleSubmitChat}>{progress === 'pending' ? 'Enviar Pergunta': 'Eviar Resposta'}</button>
			  </div> 
			)}
